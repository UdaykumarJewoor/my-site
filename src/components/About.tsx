        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-slate-400 text-base md:text-lg leading-relaxed font-medium">
              <p>
                A Software Engineer with <span className="text-white font-semibold">3+ years</span> of experience crafting scalable backend systems and modern web applications. I build with <span className="text-white font-semibold">Java, Spring Boot & React</span> — turning complex requirements into clean, production-ready solutions.
              </p>
              <p>
                Passionate about <span className="text-white font-semibold">microservices, AI integration</span>, and writing code that scales. Currently exploring the intersection of traditional engineering and intelligent systems with <span className="text-white font-semibold">Spring AI & OpenAI</span>.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-5 md:gap-6 mt-14">
              {[
                ...
                <motion.div 
                  key={i} 
                  className="space-y-3 p-4 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-brand-primary/30 hover:bg-brand-primary/5 transition-all duration-300"
                ...
                >
                  ...
                  <h4 className="font-bold text-white text-sm md:text-base">{item.label}</h4>
          ...
          >
            <div className="min-h-[500px] md:min-h-[600px] rounded-[32px] md:rounded-[48px] glass-card relative z-10 flex items-center justify-center p-8 md:p-12 group">
               <div className="text-center w-full">
                    ...
                    <div className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-linear-to-br from-brand-primary to-brand-secondary p-1 mx-auto relative z-10">
                      <div className="w-full h-full rounded-full bg-bg-dark flex items-center justify-center overflow-hidden">
                        {RESUME_DATA.profileImage ? (
                          ...
                          <span className="text-4xl md:text-6xl font-black text-white">UJ</span>
                        )}
                      </div>
                    </div>
                    <motion.div 
                  ...
                  <h3 className="text-3xl md:text-4xl font-black mb-3 text-white">{RESUME_DATA.name}</h3>
                  <p className="text-brand-secondary font-bold uppercase tracking-[0.3em] text-[10px] md:text-xs mb-10">{RESUME_DATA.title}</p>
                  
                  <div className="pt-10 border-t border-white/5 grid grid-cols-2 gap-6 md:gap-8">
                    {[
                      ...
                      >
                        ...
                        <div className="text-[9px] md:text-[10px] text-slate-500 uppercase font-black tracking-widest mt-1">{stat.label}</div>
                      </motion.div>
                    ))}
                  </div>
               </div>
