          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 md:p-12 lg:p-16 bg-brand-primary text-white relative overflow-hidden">
              <div className="relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Let's build something <br /> extraordinary.</h2>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      onChange={handleChange}
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-brand-primary transition-all resize-none"
